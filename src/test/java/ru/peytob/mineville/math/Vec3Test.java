...
class Vec3Test {
    ...
    public void testPlus() {
        ...
        assertEquals(new Vec3(5.25f, -1.0f, 100.99f), new Vec3(left).plus(right));
        assertEquals(new Vec3(15.0f, 10.0f, 8.99f), new Vec3(left).plus(10.0f));
    }
    ...
    public void testMinus() {
        ...
        assertEquals(new Vec3(14.5f, -9.1f, 107.01f), new Vec3(left).minus(right));
        assertEquals(new Vec3(-0.75f, -20.1f, -4.99f), new Vec3(left).minus(10.0f));
    }
    ...
    public void testVectorMultiplication() {
        ...
        assertEquals(new Vec3(5.75f, -30.1875f, -12.275f), new Vec3(left).vectorMultiplication(right));
    }
